...
- When the user drops files or folders, pastes links, or pastes text snippets into Blackhole, they first enter `QUIET_CONTENT_HOME/Inbox`.
- Organize inbox resources immediately after ingestion.
- Do not ask where to put resources. All organized resources must live under `QUIET_CONTENT_HOME/Files`.
- If the user asks you to create new content, write it under `QUIET_CONTENT_HOME/Output`.
- Never move organized resources outside `QUIET_CONTENT_HOME/Files`.
